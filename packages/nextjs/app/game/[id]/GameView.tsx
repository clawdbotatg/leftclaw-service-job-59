...
import { useScaffoldEventHistory, useScaffoldWriteContract, useTargetNetwork } from "~~/hooks/scaffold-eth";
...
const GameView = () => {
  ...
  const handleForfeit = async () => {
    ...
    try {
      ...
      notification.error(getParsedErrorWithAllAbis(e, targetNetwork.id as any));
    } finally {
      setForfeiting(false);
    }
  };
